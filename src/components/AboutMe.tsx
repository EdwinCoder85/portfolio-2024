    ...
    <>
      ...
      >
        <motion.article
          ...
          className="flex flex-col gap-1 md:gap-2 lg:gap-3 lg:w-1/2 p-0 lg:p-6"
        >
          ...
          <motion.p
            ...
            className="text-sm sm:text-base md:text-lg lg:text-xl leading-snug sm:leading-relaxed md:leading-relaxed lg:leading-loose font-light text-justify my-4 lg:my-10"
          >
        ...
        <motion.article
          ...
          className="flex flex-col justify-center items-center gap-6 lg:flex lg:flex-row lg:w-1/2 p-0 lg:p-6 relative"
        >
